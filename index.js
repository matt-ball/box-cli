...
folders
  ...
  .option('-p, --parent <parentId>', 'parent folder id (default: 0 for root)')
  .action(cmd('folders'))
folders
...
folders
  ...
  .option('-d, --destination <destinationId>', 'destination folder id')
...
folders
  ...
  .option('-r, --recursive', 'delete folder and all contents')
  .action(cmd('folders'))
